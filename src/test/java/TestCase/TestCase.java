...
public class TestCase extends Base {
	...
	public void searchHotel() {
		...
		s2.selectByIndex(1);
		driver.findElement(By.xpath("//*[@id='room_nos'] //*[@value='9']")).click();
		driver.findElement(By.xpath("//*[@id='adult_room'] //*[@value='3']")).click();
		driver.findElement(By.xpath("//*[@id='child_room'] //*[@value='2']")).click();
	...
	private void bookAHotel() {
		driver.findElement(By.id("first_name")).sendKeys("Alok");
